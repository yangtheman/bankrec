...
function validateTransactionData(transaction) {
  ...
  return {
    ...
    category: transaction.category ? sanitizeString(transaction.category, 100) : null,
    checkNumber: transaction.checkNumber ? sanitizeString(transaction.checkNumber, 50) : null,
    isReconciled: Boolean(transaction.isReconciled),
    plaidTransactionId: transaction.plaidTransactionId ? sanitizeString(transaction.plaidTransactionId, 100) : null,
    accountId: transaction.accountId ? sanitizeString(transaction.accountId, 100) : null
  };
}
